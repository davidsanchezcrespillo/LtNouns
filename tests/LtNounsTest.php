...
class LtNounsTest extends PHPUnit_Framework_TestCase
{
  ...
  public function testAsMissing() {
      ...
      $this->assertEquals('žaidimas', $asDeclensions['singular']['kas']);
      $this->assertEquals('žaidimo', $asDeclensions['singular']['ko']);
      $this->assertEquals('žaidimą', $asDeclensions['singular']['ką']);
      $this->assertEquals('žaidimui', $asDeclensions['singular']['kam']);
      $this->assertEquals('žaidime', $asDeclensions['singular']['kame']);
      $this->assertEquals('žaidimu', $asDeclensions['singular']['kuo']);
      $this->assertEquals('žaidime', $asDeclensions['singular']['o']);

      $this->assertEquals('žaidimai', $asDeclensions['plural']['kas']);
      $this->assertEquals('žaidimų', $asDeclensions['plural']['ko']);
      $this->assertEquals('žaidimus', $asDeclensions['plural']['ką']);
      $this->assertEquals('žaidimams', $asDeclensions['plural']['kam']);
      $this->assertEquals('žaidimuose', $asDeclensions['plural']['kame']);
      $this->assertEquals('žaidimais', $asDeclensions['plural']['kuo']);
      $this->assertEquals('žaidimai', $asDeclensions['plural']['o']);
  }

  public function testAiMissing() {
      $asDeclensions = $this->_ltNouns->generateDeclensions("rižiai")["declensions"];
      $this->assertInternalType('array', $asDeclensions);
      $this->assertInternalType('array', $asDeclensions['singular']);
      $this->assertInternalType('array', $asDeclensions['plural']);
      ...
      $this->assertEquals('rižiai', $asDeclensions['plural']['kas']);
      $this->assertEquals('rižių', $asDeclensions['plural']['ko']);
      $this->assertEquals('rižius', $asDeclensions['plural']['ką']);
      $this->assertEquals('rižiams', $asDeclensions['plural']['kam']);
      $this->assertEquals('rižiuose', $asDeclensions['plural']['kame']);
      $this->assertEquals('rižiais', $asDeclensions['plural']['kuo']);
      $this->assertEquals('rižiai', $asDeclensions['plural']['o']);
  }

  public function testOsMissing() {
      $asDeclensions = $this->_ltNouns->generateDeclensions("varnos")["declensions"];
      $this->assertInternalType('array', $asDeclensions);
      $this->assertInternalType('array', $asDeclensions['singular']);
      $this->assertInternalType('array', $asDeclensions['plural']);
  ...
  public function testEsMissing() {
      $asDeclensions = $this->_ltNouns->generateDeclensions("Moturiškės")["declensions"];
      $this->assertInternalType('array', $asDeclensions);
      $this->assertInternalType('array', $asDeclensions['singular']);
      $this->assertInternalType('array', $asDeclensions['plural']);
      ...
      $this->assertEquals('Moturiškės', $asDeclensions['plural']['kas']);
      $this->assertEquals('Moturiškių', $asDeclensions['plural']['ko']);
      $this->assertEquals('Moturiškes', $asDeclensions['plural']['ką']);
      $this->assertEquals('Moturiškėms', $asDeclensions['plural']['kam']);
      $this->assertEquals('Moturiškėse', $asDeclensions['plural']['kame']);
      $this->assertEquals('Moturiškėmis', $asDeclensions['plural']['kuo']);
      $this->assertEquals('Moturiškės', $asDeclensions['plural']['o']);
  }
